...
const omdbapiUrl = `https://www.omdbapi.com/?apikey=${apiKey}&s=`;
...
const displayInfo = (info, movie) => {
  ...
  seasonsElement.innerHTML = info.totalSeasons
  ? `<span class="info-span">(${info.totalSeasons} seasons)</span>`
  : "";
  ...
  ratedElement.textContent = info.Rated === "N/A" ? "Not Rated" : info.Rated;
  ...
  awardsElement.textContent = info.Awards === "N/A" ? "No awards" : info.Awards;
